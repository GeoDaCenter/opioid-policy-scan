...
| Foreclosure Rate | Foreclosure severe delinquency rates | HUD Neighborhood Stabilization Program, CFPB National Mortgage Database | EC04 / [Foreclosure Rate](Policy_Scan/data_final/metadata/ForeclosureRate.md) | State, County, Tract | Complete |
