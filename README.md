...
| Variable Construct | Variable Proxy | Source(s) | Metadata Document | Spatial Scale | Status<br>(for Internal team use)|
|:------------------ | -------------- | --------- | ----------------- | ------------- | -------------------------------- |
| Historical Cumulative <br>Case Count & Rate | All data, through Jan 2021 | New York Times |  | State, County |  |
| Historical 7-day Average<br>New Case Count & Rate | All data, through Jan 2021 | New York Times |  | State, County |  |
