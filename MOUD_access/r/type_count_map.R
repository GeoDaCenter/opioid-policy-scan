...
# This code prepares the count data for all MOUDs, totals the number of MOUD types within the 30 min range (0 - 3), and generates maps.
...
tmap_save(count_map.divs, "output/type_count_map.divs.png")
