# Author : Caglayan Bal
# Date : July 21, 2022
# About : This piece of code will create the 2000 demography data (census tract)
...
tractDem2000 <- read_csv("~/Desktop/Task 2/2000/Demographics_DC_2000_Tract.csv") %>%
...
colnames(tractDem2000) = c("NAME", "FIPS", "totPopE", "white", "black", "hispanic",
...
write.csv(tractDem2000P, "~/Desktop/DS01_T_2000_DC.csv")
