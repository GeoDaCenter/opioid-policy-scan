# Author : Caglayan Bal
# Date : July 24, 2022
# About : This piece of code will create the 1990 demography data (county)
...
countyDem90 <- read_csv("~/Desktop/Task 2/1990/Demographics_DC_1990_County.csv") %>%
...
colnames(countyDem90) = c("NAME", "FIPS", "totPopE", "white", "black", "hispanic",
...
write.csv(countyDem90P, "~/Desktop/DS01_C_1990_DC.csv")
