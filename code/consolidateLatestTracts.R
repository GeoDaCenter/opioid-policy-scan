...
tractsTable <- tractsTable |> mutate(
  ...
  select(
    ...
    totUnits, totWrkE, whiteP, blackP, amIndP, asianP, pacIsP, 
    otherP, hispP, ChildrenP, a15_24P, und45P, ovr65P, age0_4, 
    age5_14, age15_19, age20_24, age15_44, age45_49, age50_54, 
    age55_59, age60_64, ageOv65, ageOv18, age18_64, disbP, 
    noHSP, PctVet, nonRel_fhhR, nonRel_nfhhR, BED_COUNT, 
    POINT_IN_TIME, YEARLY_BED_COUNT, unempP, povP, MedInc, 
    pciE, fordq_rate, fordq_num, GiniCoeff, eduP, hghRskP, 
