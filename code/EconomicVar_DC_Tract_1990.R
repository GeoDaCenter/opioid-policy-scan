...
## (census tract) for policy scan based on the 1990 decennial census 
## on 2010 geographies.
...
tractEcon90 <- read_csv("~/Desktop/Task 2/1990/EconomicVar_DC_1990_Tract.csv") %>%
...
colnames(tractEcon90) = c("NAME", "FIPS", "labor", "Unemp", "totPopE", "pov")
                          

# Create a column for year

tractEcon90$year = c(1990)
...
write.csv(tractEcon90P, "~/Desktop/EC03_T_1990_DC.csv")
