# Author : Caglayan Bal
# Date : July 29, 2022
# About : This piece of code will create the 1980 demography data (county)
...
colnames(countyDem80) = c("NAME", "FIPS", "totPopE", "white", "black", "hispanic",
...
write.csv(countyDem80P, "~/Desktop/DS01_C_1980_DC.csv")
